...
public sealed record DailyCheckinGoalDto(string Id, string Name, string Period, int Target, string Unit, string Animation, string? ActivityChannel, string? GroupId, string? GroupName, string? PipelineId, string? PipelineName, bool IsActive, int SortOrder, DateTime CreatedAt, DateTime UpdatedAt, string? UserId = null, string? UserName = null, string? StageId = null, string? StageName = null);
public sealed record DailyCheckinGoalResultDto(string Id, string Name, string Period, int Target, string Unit, string Animation, string? ActivityChannel, string? GroupId, string? GroupName, string? PipelineId, string? PipelineName, int Actual, int Percent, bool Achieved, string? UserId = null, string? UserName = null, string? StageId = null, string? StageName = null);
