...
public sealed record DailyCheckinGoalDto(string Id, string Name, string Period, int Target, string Unit, string Animation, string? ActivityChannel, string? GroupId, string? GroupName, bool IsActive, int SortOrder, DateTime CreatedAt, DateTime UpdatedAt);
public sealed record DailyCheckinGoalResultDto(string Id, string Name, string Period, int Target, string Unit, string Animation, string? ActivityChannel, string? GroupId, string? GroupName, int Actual, int Percent, bool Achieved);
